  ...
  const [load, setLoad] = useState(false);
    ...
    const onSubmit = async () => {
      setLoad(true)
        ...
        axios({
          method: "POST",
          url: Base_Url + "brand/addBrandVehicle",
          headers: {
          ...
          <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
            ...
            <div style={{ backgroundColor: "", height: "7vh" }}>
              ...
              <div className="relative mb-6" data-te-input-wrapper-init>
                <label style={{fontSize:"15px",marginBottom:"20px", backgroundColor:""}}>Add Brand Name</label>
                <input
                  type="text"
              ...
              <div className="text-center lg:text-left">
                <button
                  ...
                  style={{ width: "50%", backgroundColor: "#205CBE" , marginTop:"20px"}}
                  onClick={onSubmit}
                >
                  Submit
                </button>
...
export default AddBrandNameCard
