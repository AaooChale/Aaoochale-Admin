      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <NavLink end to="/dashboard" className="block">
            <img src="aaochale.png" style={{ height: 45, width: 45 }} />
          </NavLink>
          <span className="lg:hidden lg:sidebar-expanded:block 2xl:block" style={{padding:"5px 15px", fontWeight:"bold", fontSize:'25px', color:"white"}}>
          AaooChale
        </span>
        </div>
        </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            <NavLink to="/dashboard">
                              <span
                                className="text-sm font-sm ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200"
                              >
                                Dashboard
                              </span>
                            </NavLink>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            ...
                            >
                              <span
                                className="text-sm font-sm lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200"
                              >
                                In sight
                              </span>
                            </NavLink>
